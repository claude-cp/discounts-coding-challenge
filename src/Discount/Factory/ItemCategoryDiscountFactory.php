...
class ItemCategoryDiscountFactory extends AbstractDiscountFactory
{
    ...
    private function validate(DiscountInterface $discount): void
    {
        ...
        if (0 < count($violations)) {
            throw new ViolationException($violations,
                sprintf(
                    ...
                    DiscountType::ITEM_CATEGORY->value
                ));
        }
    }
}
